...
class MessagesAPI(BaseAPIGroup):
    ...
    async def send_message(
        ...
        async def _call() -> Any:
            return await self._request_model("SendMessageResult", "POST", "messages", params=params, json_body=body)

        return await self._retry_attachment_not_ready(_call)

    async def edit_message(self, message_id: str, body: Dict[str, Any]) -> Any:
        params = {"message_id": message_id}

        async def _call() -> Any:
            return await self._request_model("SimpleQueryResult", "PUT", "messages", params=params, json_body=body)
    ...
    async def answer_on_callback(self, callback_id: str, callback: Dict[str, Any]) -> Any:
        return await self._request_model(
            "SimpleQueryResult",
            "POST",
            "answers",
